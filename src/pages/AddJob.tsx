...
export default function AddJob() {
  ...
  return (
    <div className="max-w-xl space-y-8">
      <div>
        <h1 className="text-2xl font-display font-semibold tracking-tight">Add Job</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="rounded-2xl border border-border bg-card p-6 space-y-5">
          <div className="space-y-1.5">
            ...
            <Textarea value={form.job_description} onChange={(e) => update("job_description", e.target.value)}
              ...
              rows={6} className="rounded-xl bg-background border-border/60 text-sm resize-none" />
          </div>
          <div className="space-y-1.5">
        ...
        <div className="flex gap-3">
          <Button type="submit" disabled={loading} className="rounded-xl h-10 px-5 text-sm gap-2">
